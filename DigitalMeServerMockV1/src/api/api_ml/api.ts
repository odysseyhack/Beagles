 ...
 *
 * OpenAPI spec version: 2019-04-05T00:06:13Z
 *
 *
...
export interface TravelDetailsInput {
   ...
   * @memberof TravelDetailsInput
   */
  loungueAccess?: Array<string>;
  /**
   *
   * @type {Array<string>}
   * @memberof TravelDetailsInput
   */
  shopNotifications?: Array<string>;
  /**
   *
   * @type {string}
   * @memberof TravelDetailsInput
   */
  travelType?: TravelDetailsInput.TravelTypeEnum;
  /**
   *
   * @type {string}
   * @memberof TravelDetailsInput
 ...
 */
export declare namespace TravelDetailsInput {
  /**
   * @export
   * @enum {string}
   */
...
export interface WalletStatusOutput {
  /**
   *
   * @type {Array<WalletStatusOutputTransactionsItem>}
   * @memberof WalletStatusOutput
   */
  transactions?: Array<WalletStatusOutputTransactionsItem>;
  /**
   *
   * @type {string}
   * @memberof WalletStatusOutput
 ...
 *
 * @export
 * @interface WalletStatusOutputTransactionsItem
 */
export interface WalletStatusOutputTransactionsItem {
  /**
   *
   * @type {string}
   * @memberof WalletStatusOutputTransactionsItem
   */
  mobIdToken?: string;
  /**
   *
